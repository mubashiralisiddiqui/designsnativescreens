...
export default class mapCalendar extends Component {
    render() {
        return (  
                <ScrollView>
                    <Card containerStyle={{ padding: 0, margin: 0, zIndex: -5, }}>
                        <View style={{ alignItems: 'flex-start', flexDirection: 'row', margin: 10 }}>
                            ...
                            <View style={{ marginLeft: '15%' }}>
                                <View style={{ alignItems: 'flex-end', zIndex: 1, marginLeft: '36.5%', marginTop: '-16%', width: 30, height: 30, borderRadius: 100, backgroundColor: '#6495ed', padding: 5 }}>
